...
func (m *MockDataServiceSuccessful) ReadOne(id int, ctx context.Context) (*models.Data, error) {
    return &models.Data{
        ...
        LedStatus:                 "ON",     // added
        FiveMinuteAverageSoundLevel: 58.5,   // added
    }, nil
}
...
func (m *MockDataServiceSuccessful) ReadLatest(id string, ctx context.Context) (*models.Data, error) {
    return &models.Data{
        ...
        Description:               "mock data",
        LedStatus:                 "OFF",    // added
        FiveMinuteAverageSoundLevel: 59.0,   // added
    }, nil
}
...
func (m *MockDataServiceSuccessful) ReadMany(page, rows int, ctx context.Context) ([]*models.Data, error) {
    return []*models.Data{
        ...
        },
        {
            ...
            LedStatus:                 "OFF",   // added
            FiveMinuteAverageSoundLevel: 56.0,  // added
        },
    }, nil
}
    ...
    return []*models.Data{
        {
            ...
            LedStatus:                 "ON",    // added
            FiveMinuteAverageSoundLevel: 57.0,  // added
        },
    }, nil
}
...
func (m *MockDataServiceSuccessful) GetByRoom(roomName string, ctx context.Context) ([]*models.Data, error) {
    return []*models.Data{
        {
            ID:                          1,
            DeviceID:                    "arduino_mock",
            ...
            LedStatus:                   "ON",
            FiveMinuteAverageSoundLevel: 60.5,
        },
    }, nil
}
